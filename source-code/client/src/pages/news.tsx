      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold tracking-tight text-white mb-1 flex items-center gap-3">
            <Sparkles className="w-8 h-8 text-primary" /> Smart Following Feed
          </h1>
          <p className="text-muted-foreground">Personalized insights based on your clubs, players, and scout alerts.</p>
        </div>
        <Button variant="outline" className="border-white/10 text-white">
          <Settings2 className="w-4 h-4 mr-2" /> Feed Preferences
        </Button>
      </div>
