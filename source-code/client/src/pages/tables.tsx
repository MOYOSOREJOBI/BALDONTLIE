    ...
    <div className="p-6 lg:p-8 space-y-8 pb-20">
      ...
      <Tabs defaultValue="tables" className="w-full">
        <TabsList className="bg-card/50 border border-white/5 mb-6">
          <TabsTrigger value="tables">League Tables (Top 4)</TabsTrigger>
          <TabsTrigger value="stats">Statistical Leaders</TabsTrigger>
        </TabsList>

        <TabsContent value="tables" className="space-y-6 h-[800px] overflow-y-auto custom-scrollbar pr-2 pb-12">
        ...
        <TabsContent value="stats" className="space-y-6 h-[800px] overflow-y-auto custom-scrollbar pr-2 pb-12">
