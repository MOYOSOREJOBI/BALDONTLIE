...
export default function MatchCenter() {
  ...
  return (
    <div className="p-6 lg:p-8 space-y-4 pb-24 h-full flex flex-col">
      {/* Top Strip */}
        ...
        <CardContent className="p-4 flex flex-col lg:flex-row justify-between items-center gap-4">
           <div className="flex items-center gap-6 w-full lg:w-auto justify-between lg:justify-start">
              <div className="flex items-center gap-3">
                 ...
                 <h2 className="text-xl font-display font-bold hidden md:block">Real Madrid</h2>
              </div>
              <div className="flex flex-col items-center px-4">
                 <div className="text-primary text-xs font-bold mb-1 flex justify-center items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" /> {minute}' : 42"
                 </div>
              ...
              <div className="flex items-center gap-3">
                 <h2 className="text-xl font-display font-bold hidden md:block">Man City</h2>
           ...
           <div className="flex items-center gap-6">
              ...
              <div className="flex gap-2">
                 <Button variant="outline" size="sm" className="border-primary/50 text-primary bg-primary/10">
                   <Radio className="w-3 h-3 mr-2 animate-pulse" /> Radio
                 </Button>
                 <Button size="sm" className="bg-red-600 hover:bg-red-700 text-white border-none shadow-[0_0_15px_rgba(220,38,38,0.5)]">
                   <PlayCircle className="w-3 h-3 mr-2" /> Watch Live
                 </Button>
               ...
               <TabsContent value="comm" className="m-0 p-4 space-y-4">
                  ...
                  <div className="p-4 bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 rounded-xl relative overflow-hidden">
                     ...
                     <div className="flex items-center gap-2 mb-2 text-primary font-bold text-[10px] uppercase tracking-wider">
                       <Volume2 className="w-3 h-3 animate-pulse" /> Live Radio Comm
                     </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 shrink-0">
         <Card className="glass-card bg-card/40 border-white/10 lg:col-span-2">
            <CardContent className="p-4 flex items-center justify-between">
               ...
               <div className="h-8 w-48 bg-white/5 rounded relative overflow-hidden border border-white/10">
                  {/* Mini momentum chart */}
         ...
         <Card className="glass-card bg-card/40 border-white/10 flex items-center justify-center gap-4 p-4">
            <Button variant="outline" size="sm" className="w-full text-xs"><MessageCircle className="w-3 h-3 mr-2"/> Join Chat</Button>
