import { ArrowRight, BookOpen, CandlestickChart, Coins, ShieldCheck, Users } from "lucide-react";
      ...
      <div className="relative grid gap-8 xl:grid-cols-[1.6fr_1fr]">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              className="rounded-full px-6 shadow-[0_0_24px_rgba(118,255,3,0.18)]"
            ...
            <Button
              variant="outline"
              className="rounded-full border-white/10 bg-white/5 px-6 text-white"
            ...
            <Button
              variant="ghost"
              className="rounded-full border border-transparent px-6 text-muted-foreground hover:text-white"
              onClick={onLearn}
            >
