...
const gameCards = [
  {
    title: "Market XI",
    description:
      "Trade footballers like virtual assets, rotate a simulation portfolio, and explore form-driven repricing across men’s and women’s football.",
...
export function GamesHubPage() {
  return (
    <div className="space-y-8 p-4 pb-20 sm:p-6 lg:p-8">
      <section className="relative overflow-hidden rounded-[30px] border border-white/8 bg-[radial-gradient(circle_at_top_left,rgba(118,255,3,0.14),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.15),transparent_30%),linear-gradient(135deg,rgba(15,23,42,0.98),rgba(2,6,23,0.92))] p-6 shadow-[0_18px_55px_rgba(2,6,23,0.45)] sm:p-8">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.35fr_0.95fr]">
          <div className="space-y-5">
            ...
            <div>
              <h1 className="max-w-[16ch] text-4xl font-display font-bold tracking-tight text-white md:max-w-none md:text-5xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
                ...
                play into premium simulation products. Market XI leads the current lineup as
                the most complete demo surface in the repo.
              </p>
            </div>
          </div>
