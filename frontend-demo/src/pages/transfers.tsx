    ...
    <div className="p-6 lg:p-8 space-y-6 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Prototype squad planning, rumour review, and replacement-fit concepts built from mock transfer data.</p>
        </div>
        <Badge className="bg-primary/20 text-primary border-primary/30 py-1.5 px-4 font-semibold">Window Watch Demo</Badge>
      </div>
      ...
      <Tabs defaultValue="planner" className="w-full space-y-6">
        <TabsList className="bg-card/40 border border-white/10 rounded-lg p-1">
           ...
           <TabsTrigger value="rumours" className="text-xs sm:text-sm">Rumour Board</TabsTrigger>
           <TabsTrigger value="risers" className="text-xs sm:text-sm">Value Movers</TabsTrigger>
        </TabsList>
