    ...
    <div className="p-6 lg:p-8 space-y-8 pb-20">
      <div>
        <h1 className="text-3xl font-display font-bold tracking-tight text-white mb-1 flex items-center gap-3">
          <Trophy className="w-8 h-8 text-yellow-500" /> Global Rankings Board
        </h1>
        <p className="text-muted-foreground">Prototype ranking board based on mock intelligence inputs and frontend scoring logic.</p>
      </div>
