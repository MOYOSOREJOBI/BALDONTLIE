    ...
    <div className="p-6 lg:p-8 space-y-8 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">{t('A premium prototype snapshot of global football surfaces, scouting-style cards, and discovery views.')}</p>
        </div>
        <div className="flex items-center gap-2 bg-card/60 backdrop-blur-md border border-primary/30 rounded-full px-4 py-2 text-sm font-medium shadow-[0_0_15px_rgba(118,255,3,0.1)]">
          ...
          <span className="text-primary font-bold">PROTOTYPE SNAPSHOT</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        {/* Player of the Week */}
        <div className="group flex min-h-[152px] flex-col gap-3 rounded-2xl border border-blue-500/20 bg-card/40 p-4 shadow-lg transition-colors hover:bg-card/60 cursor-pointer">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-blue-500/10 text-blue-500">
                <Star className="w-4 h-4" />
              </div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Player of the Week</div>
            </div>
            <Badge className="bg-blue-500/20 text-blue-400 border-none text-[10px]">EPL</Badge>
          </div>
          <div className="space-y-1 pl-1">
             <div className="text-xl font-display font-bold leading-tight text-white transition-colors group-hover:text-blue-400 sm:text-2xl">K. Mainoo</div>
             <div className="text-sm font-medium leading-5 text-muted-foreground">Man Utd vs Liverpool (9.2 Rtg)</div>
          </div>
        </div>

        {/* Team of the Week */}
        <div className="group flex min-h-[152px] flex-col gap-3 rounded-2xl border border-purple-500/20 bg-card/40 p-4 shadow-lg transition-colors hover:bg-card/60 cursor-pointer">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-purple-500/10 text-purple-500">
                <Shield className="w-4 h-4" />
              </div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Team of the Week</div>
            </div>
            <Badge className="bg-purple-500/20 text-purple-400 border-none text-[10px]">UCL</Badge>
          </div>
          <div className="space-y-1 pl-1">
             <div className="text-xl font-display font-bold leading-tight text-white transition-colors group-hover:text-purple-400 sm:text-2xl">Real Madrid</div>
             <div className="text-sm font-medium leading-5 text-muted-foreground">Defensive Masterclass v City</div>
          </div>
        </div>

        {/* Manager of the Week */}
        <div className="group flex min-h-[152px] flex-col gap-3 rounded-2xl border border-orange-500/20 bg-card/40 p-4 shadow-lg transition-colors hover:bg-card/60 cursor-pointer">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-orange-500/10 text-orange-500">
                <Users className="w-4 h-4" />
              </div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Manager of the Week</div>
            </div>
            <Badge className="bg-orange-500/20 text-orange-400 border-none text-[10px]">AFCON</Badge>
          </div>
          <div className="space-y-1 pl-1">
             <div className="text-xl font-display font-bold leading-tight text-white transition-colors group-hover:text-orange-400 sm:text-2xl">Eric Chelle</div>
             <div className="text-sm font-medium leading-5 text-muted-foreground">Mali National Team Tactical Masterclass</div>
          </div>
        </div>

        {/* Goal of the Week */}
        <div className="group flex min-h-[152px] flex-col gap-3 rounded-2xl border border-primary/20 bg-card/40 p-4 shadow-lg transition-colors hover:bg-card/60 cursor-pointer">
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-primary/10 text-primary">
                <Target className="w-4 h-4" />
              </div>
              <div className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Goal of the Week</div>
            </div>
            <Badge className="bg-primary/20 text-primary border-none text-[10px] animate-pulse">90+8'</Badge>
          </div>
          <div className="space-y-1 pl-1">
             <div className="text-xl font-display font-bold leading-tight text-white transition-colors group-hover:text-primary sm:text-2xl">B. Šeško</div>
             <div className="text-sm font-medium leading-5 text-muted-foreground">RB Leipzig vs Man City (Volley)</div>
          </div>
        </div>
      </div>
      ...
      <div className="columns-1 lg:columns-2 xl:columns-3 gap-6 space-y-6">
        ...
        <Card className="glass-card bg-card/40 border-yellow-500/30 break-inside-avoid shadow-lg shadow-yellow-500/10">
          <CardHeader className="pb-0">
            ...
            <p className="text-sm text-muted-foreground mt-1">Comparative trend over time based on mock sentiment, momentum, and output inputs.</p>
          </CardHeader>
          <CardContent>
