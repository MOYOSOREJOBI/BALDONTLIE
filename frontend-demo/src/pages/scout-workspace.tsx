      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-display font-bold tracking-tight text-white mb-1 flex items-center gap-3">
            <Database className="w-8 h-8 text-primary" /> Scout Workspace Demo
          </h1>
          <p className="text-muted-foreground">Static scouting workflow concept for search, shortlists, and succession planning.</p>
        </div>
        <div className="flex gap-2">
           <Button variant="outline" className="border-primary/50 text-primary">
             <Save className="w-4 h-4 mr-2" /> Save Demo Filter
           </Button>
           <Button variant="default">
             <Plus className="w-4 h-4 mr-2" /> New Demo Shortlist
           </Button>
        </div>
      </div>

      <div className="rounded-2xl border border-white/10 bg-card/30 p-4 text-sm leading-6 text-muted-foreground">
        This workspace is currently a frontend concept view. Search results, shortlist actions, and readiness signals are mock interactions used to shape the eventual scouting UX.
      </div>
           ...
           {activeTab === 'search' && (
             <div className="space-y-4">
                <div className="relative">
                  ...
                  <Input placeholder="Search the prototype scouting pool..." className="pl-10 bg-black/40 border-white/10 w-full" />
                </div>
