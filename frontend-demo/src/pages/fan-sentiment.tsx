    ...
    <div className="p-6 lg:p-8 space-y-8 pb-20">
      <div>
        <h1 className="text-3xl font-display font-bold tracking-tight text-white mb-1 flex items-center gap-3">
          <Heart className="w-8 h-8 text-red-500" /> Sentiment Demo & Demand Signals
        </h1>
        <p className="text-muted-foreground">Prototype view of fan discussion patterns, hype swings, and debate intensity using mock social inputs.</p>
      </div>

      <div className="rounded-2xl border border-white/10 bg-card/30 p-4 text-sm leading-6 text-muted-foreground">
        Sentiment, debate counts, and global heatmap markers on this page are mock presentation data.
        They illustrate the intended product surface, not a live social listening pipeline.
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="glass-card bg-card/40 lg:col-span-2">
          <CardHeader className="pb-3 border-b border-white/5">
            ...
            <p className="text-sm text-muted-foreground">Prototype map of where player attention is concentrated across mock regions.</p>
          </CardHeader>
