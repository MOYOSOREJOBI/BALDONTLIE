...
export default function PlayerProfile() {
  ...
  const marketValueLabel = player.value.startsWith("€") ? player.value : `€${player.value}`;
  const wageLabel = player.wage.startsWith("€") ? player.wage : `€${player.wage}`;
  const trendAccent =
    player.trend === "up"
      ? {
          label: "Rising stock",
  ...
  const overviewSignals = [
    {
      label: "Trend",
      value: trendAccent.label,
      detail:
        player.trend === "up"
          ? "Market narrative and output are moving in the same direction."
          : player.trend === "down"
            ? "The market is pausing while performances cool off."
            : "Output is steady with no major volatility spike.",
      icon: trendAccent.icon,
      badgeClassName: trendAccent.badge,
      accentClassName: trendAccent.tone,
    },
    {
      label: "Ball progression",
      value: `${Math.round((player.stats.passing + player.stats.dribbling) / 2)}/100`,
      detail: "Combination of passing quality and carry threat through lines.",
      icon: ArrowUpRight,
    ...
    },
    {
      ...
      value: `${player.sentiment}% confidence`,
      detail: "Confidence, role trust, and public momentum are all elevated.",
      icon: BrainCircuit,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
                ...
                <div className="flex-1 space-y-5">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-background/40 border border-white/5 backdrop-blur-sm">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-white">{marketValueLabel}</div>
                    </div>
                    <div>
                      <div className="text-xs text-muted-foreground mb-1 font-medium uppercase tracking-wider">Wage / Wk</div>
                      <div className="text-lg font-bold text-white">{wageLabel}</div>
                    </div>
                    <div>
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            <div className={`mt-2 text-lg font-display font-semibold ${signal.accentClassName}`}>
                              {signal.value}
                            </div>
                          </div>
                          <div className="rounded-xl border border-white/10 bg-white/5 p-2">
                            <signal.icon className={`h-4 w-4 ${signal.accentClassName}`} />
                          </div>
                        </div>
          ...
          <Tabs defaultValue="overview" className="w-full">
            <TabsList className="hide-scrollbar h-12 w-full justify-start overflow-x-auto border border-white/5 bg-card/50 p-1">
              <TabsTrigger value="overview" className="h-9 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm">Overview</TabsTrigger>
              <TabsTrigger value="intelligence" className="flex h-9 items-center gap-2 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm"><BrainCircuit className="w-3 h-3" /> Intelligence</TabsTrigger>
              <TabsTrigger value="compare" className="h-9 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm">Compare</TabsTrigger>
              <TabsTrigger value="stats" className="h-9 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm">Detailed Stats</TabsTrigger>
              <TabsTrigger value="matches" className="h-9 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm">Matches</TabsTrigger>
              <TabsTrigger value="market" className="h-9 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm">Transfer Market</TabsTrigger>
              <TabsTrigger value="highlights" className="flex h-9 items-center gap-2 whitespace-nowrap rounded-md px-4 text-xs data-[state=active]:bg-primary/20 data-[state=active]:text-primary sm:px-6 sm:text-sm"><Flame className="w-3 h-3" /> Highlights & Media</TabsTrigger>
            </TabsList>
            ...
            <div className="mt-6 space-y-6">
              ...
              <TabsContent value="overview" className="space-y-6 m-0">
                <div className="grid grid-cols-1 gap-4 xl:grid-cols-3">
                  <Card className="glass-card border-white/5 bg-card/40 xl:col-span-2">
                    <CardContent className="flex flex-col gap-4 p-5 md:flex-row md:items-center md:justify-between">
                      <div>
                        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                          Snapshot
                        </div>
                        <div className="mt-2 text-2xl font-display font-semibold text-white">
                          Elite creative midfielder profile
                        </div>
                        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                          The overview below balances core attributes, recent form, and role clarity
                          so the screen feels more like a finished scouting panel than a loose stack
                          of widgets.
                        </p>
                      </div>
                      <div className="grid grid-cols-2 gap-3 text-sm sm:min-w-[260px]">
                        ...
                        <div className="rounded-2xl border border-white/8 bg-black/20 p-3">
                          ...
                          <div className="mt-2 text-xl font-display font-semibold text-primary">
                            Core XI
                          </div>
                        </div>
                      </div>
                  ...
                  <Card className="glass-card border-primary/15 bg-primary/5">
                    <CardContent className="p-5">
                      ...
                      <div className="mt-3 text-lg font-display font-semibold text-white">
                        High-touch creator in advanced central zones
                      </div>
                      <p className="mt-2 text-sm leading-6 text-muted-foreground">
                        Best work appears between half spaces, late box arrivals, and
                        tempo-setting actions under moderate pressure.
                      </p>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    <CardContent className="flex-1 flex flex-col justify-end pt-6">
                      <div className="mb-6 grid grid-cols-3 gap-3">
                        <div className="rounded-xl border border-white/8 bg-black/20 p-3 text-center">
                          ...
                          <div className="mt-1 text-lg font-display font-semibold text-white">7.9</div>
                        </div>
                        <div className="rounded-xl border border-primary/20 bg-primary/10 p-3 text-center">
                          ...
                          <div className="mt-1 text-lg font-display font-semibold text-primary">8.9</div>
                        </div>
                        <div className="rounded-xl border border-white/8 bg-black/20 p-3 text-center">
                          <div className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground">
                            Trend
                          </div>
                          <div className={`mt-1 text-lg font-display font-semibold ${trendAccent.tone}`}>
                            {player.trend === "up" ? "Up" : player.trend === "down" ? "Down" : "Flat"}
                          </div>
                        </div>
                      </div>
                ...
                <Card className="glass-card bg-card/40 border-white/5">
                  <CardHeader className="flex flex-row items-center justify-between pb-2">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-sm font-bold border border-primary/20">
                      <TrendingUp className="w-4 h-4" /> {marketValueLabel} (+15%)
                    </div>
                  </CardHeader>
                  <CardContent>
                    <div className="h-[300px] w-full mt-4">
